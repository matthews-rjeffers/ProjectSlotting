...
namespace ProjectScheduler.Migrations
{
    ...
    [Migration("20251021032545_ReplaceWeekStartDateWithStartEndDate")]
    partial class ReplaceWeekStartDateWithStartEndDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectScheduler.OnsiteSchedule", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProjectId" }, "IX_OnsiteSchedules_ProjectId");

                    b.ToTable("OnsiteSchedules");
                });

            modelBuilder.Entity("ProjectScheduler.Project", b =>
                {
                    b.Property<int>("ProjectId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("CodeCompleteDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ProjectScheduler.ProjectAllocation", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProjectId", "SquadId", "AllocationDate", "AllocationType" }, "IX_ProjectAllocations_ProjectId_SquadId_AllocationDate_Type")
                        .IsUnique();
            ...
            modelBuilder.Entity("ProjectScheduler.Squad", b =>
                {
                    b.Property<int>("SquadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProjectScheduler.TeamMember", b =>
                {
            ...
            modelBuilder.Entity("ProjectScheduler.OnsiteSchedule", b =>
                {
                    b.HasOne("ProjectScheduler.Project", "Project")
            ...
            modelBuilder.Entity("ProjectScheduler.ProjectAllocation", b =>
                {
                    ...
                    b.HasOne("ProjectScheduler.Squad", "Squad")
                        .WithMany("ProjectAllocations")
